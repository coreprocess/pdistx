_virtual_modules = {
    "custom_widgets.main_window": {
        "is_package": False,
        "code": 'import bz2, base64\nexec(bz2.decompress(base64.b64decode("")))\n',
    },
    "custom_widgets": {
        "is_package": True,
        "code": 'import bz2, base64\nexec(bz2.decompress(base64.b64decode("QlpoORdyRThQkAAAAAA=")))\n',
    },
}
